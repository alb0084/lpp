...
// Molecule: SimpleGraph
Molecule<std::string> SimpleGraph;
SimpleGraph.addAtom("A");
SimpleGraph.addAtom("B");
SimpleGraph.addAtom("C");
SimpleGraph.addBond("A", "B", BondType::SINGLE);
SimpleGraph.addBond("B", "C", BondType::SINGLE);
SimpleGraph.addBond("C", "A", BondType::SINGLE);


// Molecule: DirectedGraph
Molecule<std::string> DirectedGraph;
DirectedGraph.addAtom("Start");
DirectedGraph.addAtom("Middle");
DirectedGraph.addAtom("End");
DirectedGraph.addBond("Start", "Middle", BondType::ARROW);
DirectedGraph.addBond("Middle", "End", BondType::ARROW);


// Molecule: MixedGraph
Molecule<std::string> MixedGraph;
MixedGraph.addAtom("Node1");
MixedGraph.addAtom("Node2");
MixedGraph.addAtom("Node3");
MixedGraph.addAtom("Node4");
MixedGraph.addBond("Node1", "Node2", BondType::SINGLE);
MixedGraph.addBond("Node2", "Node3", BondType::DOUBLE);
MixedGraph.addBond("Node3", "Node4", BondType::ARROW);


{ main() {
    return println("Molecule syntax test compiled successfully!");
}
