...
Network.addAtom("Client");
Network.addAtom("Server");
Network.addAtom("Database");
Network.addBond("Client", "Server", BondType::BIDIRECTIONAL);
Network.addBond("Server", "Database", BondType::BIDIRECTIONAL);


// Molecule: Mixed
Molecule<std::string> Mixed;
Mixed.addAtom("A");
Mixed.addAtom("B");
Mixed.addAtom("C");
Mixed.addAtom("D");
Mixed.addAtom("E");
Mixed.addBond("A", "B", BondType::SINGLE);
Mixed.addBond("B", "C", BondType::DOUBLE);
Mixed.addBond("C", "D", BondType::ARROW);
Mixed.addBond("D", "E", BondType::BIDIRECTIONAL);
